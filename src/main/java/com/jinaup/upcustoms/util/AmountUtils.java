...
public class AmountUtils {
	...
	/**
	 * 佣金比例修改，将小于100的乘以100，大于100的直接返回
	 * 
	 * @param amount
	 * @return
	 */
	public static String changeCommissionRate(String commissionRate) {
		BigDecimal commissionRateBigDecimal = new BigDecimal(commissionRate);
		BigDecimal commissionRateBigDecimal100 = new BigDecimal("100");
		int compareTo = commissionRateBigDecimal.compareTo(commissionRateBigDecimal100);
		if(compareTo==1){
			return commissionRate;
		}else{
			return commissionRateBigDecimal.multiply(commissionRateBigDecimal100).toString();
		}
	}
